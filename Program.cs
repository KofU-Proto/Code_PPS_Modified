...
namespace Numberics
{
    class MainClass
    {
        ...
        // Gói tính tính các Omega(x)/(x-xi) hoặc Omega(x)
        ...
        public static void Horner()// Hoocne
        {
            int key, N;// key là , N là bậc của biểu thức
            double c; // (x-c)
            //Menu

            Console.WriteLine("1.Pn(x) => an(x-c)^n+...+a1(x-c)+a0 // ");

            Console.WriteLine("2.an(x-c)^n+...+a1(x-c)+a0=>Pn(x) // Tính giá trị hàm nội suy (nhập giá trị để thử lại)");
            
            Console.WriteLine("3.Pn(x)/(x-c) // Hoocne thương");
            
            Console.WriteLine("4.(x-x0)(x-x1)...(x-x(n-1))=>Pn(x) // Hoocne nhân");
        ...
        public static void Lagrange1() // Lagrange
        {
            Console.WriteLine("Nhập số điểm nội suy");
            int N = Convert.ToInt16(Console.ReadLine());
            double[] x = new double[N]; //Mốc nối suy
            double[] y = new double[N]; //Giá trị mốc nội suy
            double[] L = new double[N]; //Giá trị hệ số Lagrange
            double[] P = new double[N]; //Hàm nội suy
            double[] tich = new double[N - 1]; //Các mốc nội suy tương ứng với các hệ số Lagrange
            for (int i = 0; i < N; i++)
            {
            ...
            //1.1 Hiển thị gói tính các yi/Di
            Console.WriteLine("Mảng các yi/Di: \n");
            for (int i = 0; i < N; i++)
            {
                Console.WriteLine(L[i]);
            }
            //2. Tính hệ số của hàm nội suy Langrage
            for (int i = 0; i < N; i++)
            {
                for (int j = 0; j < N; j++)  //2.1 Hàm duyệt các mốc tương ứng các Omega(x)/(x-xi)
                {
                    if (i > j) tich[j] = x[j];
                ...
                for (int j = 0; j < N; j++) 
                {
                    P[j] += L[i] * NDT(tich)[j]; //2.2 Tính tích hệ số Lagrange với Omega(x)/(x-xi)
                }
            }
            //3. Hiện thị hàm nội suy ra màn hình            
        ...
        public static void Newton()
        {
            ...
            */
            ...
            //1. Tính tỷ sai phân cấp 1
            for (int i = 0; i < N - 1; i++)
            {
                tyhieu[i, 0] = (y[i + 1] - y[i]) / (x[i + 1] - x[i]);
            }
            //2. Tính tỷ sai phân cấp tiếp theo
            for (int i = 1; i < N - 1; i++)
            {
                for (int j = 0; j < N - 1 - i; j++)
                {
                    tyhieu[j, i] = (tyhieu[j + 1, i - 1] - tyhieu[j, i - 1]) / (x[j + i + 1] - x[j]);
                }
            }
        ...
        public static void NewtonCD()
        {
            ...
            double[] y = new double[N];
            double[,] tyhieu = new double[N, N - 1];
            double[,] saiphan = new double[N, N - 1];
            /*
            double[] x =
            {
                27,24,21,18,15,12,9,6,3,0
            ...
            */
            ...
            //Console.WriteLine(Y);
            #endregion
            /* Trường hợp đã đổi biến 
             * 
             * Author : LTLONG(25/11/2021)
             */
            #region TH đổi biến
            //1. Tính sai phân cấp 1
            for (int i = 0; i < N - 1; i++)
            {
                saiphan[i, 0] = y[i + 1] - y[i];
            }
            //2. Tính sai phân cấp tiếp theo
            for (int i = 1; i < N - 1; i++)
            {
                for (int j = 0; j < N - 1 - i; j++)
                {
                    saiphan[j, i] = (saiphan[j + 1, i - 1] - saiphan[j, i - 1]);
                }
            }
            //3. Hiển thị bảng sai phân
            Console.WriteLine("Bảng tỷ sai phân sau khi đổi biến:\n");
            for (int i = 0; i < N; i++)
            {
                for (int j = 0; j < N - 1; j++)
                {
                    Console.Write(saiphan[i, j] + "   ");
                    if (j == N - 2) Console.Write("\n");
                }
            }
            //4. Tính lại mảng sai phân
            for (int i = 0; i < N - 1; i++)
            {
                saiphan[0, i] = saiphan[0, i] / Giaithua(i + 1);
            }
            //5. Hiển thị mảng sai phân sau khi đổi biến
            Console.WriteLine("Mảng tỷ sai phân sau khi đổi biến:\n");
            for (int i = 0; i < N - 1; i++)
            {
                Console.Write(saiphan[0, i] + "   ");
            }
            //6. Tính tích
            double[] P = new double[N]; ;
            for (int i = N - 1; i > 0; i--)
            {
                ...
                for (int j = N - 1; j >= N - i - 1; j--)
                {
                    P[j] += saiphan[0, i - 1] * NDT(L)[i - N + 1 + j];
                }
            }
            P[N - 1] += y[0];
            Console.WriteLine("\n Hàm xấp xỉ: \n");
        ...
        cp:
            ...
            //1. Tính sai phân mốc ban đầu
            for (int i = 0; i < N - 1; i++)
            {
                delta[i, 0] = y[i + 1] - y[i];
            }
            //2. Tính sai phân mốc tiếp theo
            for (int i = 1; i < N; i++)
            {
            ...
            //3. Hiển thị bảng sai phân trung tâm
            ...
            //4. Tính tỷ sai phân sau khi đổi biến
            Console.WriteLine("Tỷ sai phân sau khi đổi biến:");
            double[] P = new double[N];
            for (int i = 1; i < N; i++)
            {
                double[] L = new double[i];
                for (int j = 0; j < i; j++)
                {
                    if (i % 2 != 0) L[j] = (1 - i) / 2 + j; // Tính các bước đi 
                    else L[j] = (2 - i) / 2 + j;
                }
                for (int j = N - 1; j >= N - i - 1; j--)
                {
                    if (i % 2 == 0)
                    {
                        P[j] += NDT(L)[j - N + 1 + i] * delta[(N - i - 1) / 2, i - 1] / Giaithua(i);
                    }
                    else
                    {
                        P[j] += NDT(L)[j - N + 1 + i] * delta[(N - i) / 2, i - 1] / Giaithua(i);
                    } 
                }
                //Hiển thị mảng sai phân cần dùng
                if (i % 2 == 0)
                {
                    Console.WriteLine(delta[(N - i - 1) / 2, i - 1] / Giaithua(i));
                }
                else
                {
                    Console.WriteLine(delta[(N - i) / 2, i - 1] / Giaithua(i));
                }
            }
        ...
        cp:
            ...
            //1. Tính các tỷ sai phân cấp 1
            for (int i = 0; i < N - 1; i++)
            {
                delta[i, 0] = y[i + 1] - y[i];
            }
            //2. Tính các tỷ sai phân cấp khác
            for (int i = 1; i < N; i++)
            {
                for (int j = 0; j < N - i - 1; j++)
                {
            ...
            for (int i = 1; i < N; i++)
            {
                ...
                {
                    Console.WriteLine(delta[(N - i - 2) / 2, i - 1] / Giaithua(i));
                }
            }
            P[N - 1] += y[(N - 1) / 2];
            Console.WriteLine("Hàm xấp xỉ: \n");
        ...
        cp:
            ...
            //1. Tính các sai phân bậc 1
            for (int i = 0; i < N - 1; i++)
            {
                delta[i, 0] = y[i + 1] - y[i];
            }
            //2. Tính các sai phân bậc tiếp theo
            for (int i = 1; i < N; i++)
            {
                for (int j = 0; j < N - i - 1; j++)
                {
            ...
            //4. Lấy ra các sai phân cần dùng
            Console.WriteLine("Mảng tỷ sai phân sau khi đổi biến");
            double[] P = new double[N];
            for (int i = 1; i < N; i++)
            {
                ...
                // Mảng tỷ sai phân khi đã đổi biến
                if (i % 2 == 0)
                {
                    Console.WriteLine(delta[(N - i - 1) / 2, i - 1] / Giaithua(i));
                }
                ...
                {
                    Console.WriteLine((delta[(N - i) / 2, i - 1] + delta[(N - i - 2) / 2, i - 1]) / (2 * Giaithua(i)));
                }
            }
            P[N - 1] += y[(N - 1) / 2];
            Console.WriteLine("Hàm xấp xỉ: \n");
        ...
        cp:
            ...
            Console.WriteLine("Mảng tỷ sai phân Guass1");
            double[] P = new double[N];
            for (int i = 1; i < N; i++)
            {
                double[] L = new double[i];
